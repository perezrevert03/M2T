		...
		addAnnotation
		  (esquemaEClass, 
		   ...
		   new String[] {
			 ...
			 "ClavesDistintas", "self.clavesAjenas->forAll(ca1 : ClaveAjena, ca2 : ClaveAjena | ca1.columna = ca2.columna and ca1.columnaReferenciada = ca2.columnaReferenciada implies ca1 = ca2)",
			 "NombreNoNulo", "not self.Nombre.oclIsUndefined()"
		   });	
		addAnnotation
		  (claveAjenaEClass, 
		   source, 
		   new String[] {
			 "OrigenDistintoDestino", "self.columna<> self.columnaReferenciada",
			 "ColumnaReferenciaPrimaria", "self.columnaReferenciada.EsPrimaria",
			 "NombreNoNulo", "not self.Nombre.oclIsUndefined()",
			 "ColumnaNoPrimaria", "not self.columna.EsPrimaria",
			 "TiposIguales", "self.columna.Tipo=self.columnaReferenciada.Tipo"
		   });
	}
